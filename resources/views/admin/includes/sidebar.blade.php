    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                ...
                <li class="nav-item mx-auto">
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}">
                        <span class="brand-logo">
                            ...
                            <img src="{{asset('app-assets/images/logo/heigais.png')}}" alt="">
                        </span>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @if(auth()->user()->hasPermission('manage-dashboard'))
                    <li class=" nav-item {{ Request::is(['admin/dashboard/*', 'admin/dashboard']) ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('admin.dashboard')}}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboard</span></a>
                    </li>
                @endif
                @if(auth()->user()->hasPermission('manage-subadmins'))
                    <li class=" nav-item {{ Request::is(['admin/admins/*', 'admin/admins']) ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('admins.index')}}"><i data-feather="award"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Admins</span></a>
                    </li>
                @endif
                @if(auth()->user()->hasPermission('manage-users'))
                    <li class=" nav-item {{ Request::is(['admin/users/*', 'admin/users']) ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('users.index')}}"><i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Users</span></a>
                    </li>
                @endif
                @if(auth()->user()->hasPermission('manage-events'))
                    <li class=" nav-item {{ Request::is(['admin/events/*', 'admin/events']) ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('events.index')}}"><i data-feather="list"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Events</span></a>
                    </li>
                @endif
                @if(auth()->user()->hasPermission('manage-categories'))
                    <li class=" nav-item {{ Request::is(['admin/categories/*', 'admin/categories']) ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('categories.index')}}"><i data-feather="box"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Categories</span></a>
                    </li>
                @endif
                ...
                <li class="active nav-item"><a class="d-flex align-items-center" href="ui-typography.html"><i data-feather="type"></i><span class="menu-title text-truncate" data-i18n="Typography">Typography</span></a>
                </li>
