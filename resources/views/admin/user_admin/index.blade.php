    ...
    <!-- END: Page JS-->
       ...
       <script>
            ...
            $(document).ready(function(){
                tablet = $('#admin-table').DataTable({
                    ajax:{
                            url: "{{ route('get_all_admins') }}"
                    },
                    "columns": [
       ...
       <script>
            ...
            function delete_admin_alert(id){
                        Swal.fire({
            ...
            function activate_admin_alert(id){
                Swal.fire({
           ...
           <div class="content-body">
               <div class="row">
                   <div class="col-auto ml-auto mb-2">
                        <a href="{{route('admins.create')}}" type="button" class="btn btn-primary"> Create </a>
                   </div>
               </div>
               <!-- Row grouping -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-datatable">
                                <table class="table" id="admin-table">{{--dt-row-grouping--}}
                                    <thead>
                                        <tr>
                                            <th>id</th>
                                            <th>Name</th>
